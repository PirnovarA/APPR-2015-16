...
Na spodnjem zemljevidu je prikazano razmerje med posameznimi zveznimi državami in povprečnimi plačami. Osnovne barve so za leto 2014, a z "preletom" miške vidimo še povprečne plače v preteklih letih.   


```{r povp_plača_zemljevid, echo=FALSE}
switch (type,
